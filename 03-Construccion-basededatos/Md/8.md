...
- Base de datos (SQL): [03-Construccion-basededatos/DB/08_comercializadora.sql](../DB/08_comercializadora.sql)
- Diagrama SQL (imagen): [03-Construccion-basededatos/img_diagramas_BD/08-Comercializadora.png](../img_diagramas_BD/08-Comercializadora.png)
- Modelo relacional (.drawio): [02-Modelado-basededatos/ER-a R/Relacional/8R_Comercializadora.drawio](../../02-Modelado-basededatos/ER-a%20R/Relacional/8R_Comercializadora.drawio)
- Imagen del modelo: [02-Modelado-basededatos/ER-a R/Relacional/8.png](../../02-Modelado-basededatos/ER-a%20R/Relacional/8.png)

## Vista de diagramas (para no confundirse)

### 1) Modelo relacional (diseno)

![Modelo relacional ejercicio 8](../../02-Modelado-basededatos/ER-a%20R/Relacional/8.png)

### 2) Diagrama SQL (implementacion en tablas)

![Diagrama SQL ejercicio 8](../img_diagramas_BD/08-Comercializadora.png)

## Descripcion del ejercicio

Base de datos para una comercializadora que administra productos, representantes, oficinas, clientes, pedidos y detalle de pedido.

## Problematica

Se necesita controlar ventas con multiples relaciones, jerarquia de representantes, control de existencia de productos y auditoria de registros.
