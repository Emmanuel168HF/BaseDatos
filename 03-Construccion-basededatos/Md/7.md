# Ejercicio 7: Administracion Universitaria

## Vinculos

- Base de datos (SQL): [03-Construccion-basededatos/DB/07_universidad.sql](../DB/07_universidad.sql)
- Modelo relacional (.drawio): [02-Modelado-basededatos/ER-a R/Relacional/7R.drawio](../../02-Modelado-basededatos/ER-a%20R/Relacional/7R.drawio)
- Imagen del modelo: [02-Modelado-basededatos/ER-a R/Relacional/7.png](../../02-Modelado-basededatos/ER-a%20R/Relacional/7.png)
- Diagrama SQL (imagen): [03-Construccion-basededatos/img_diagramas_BD/07-universidad.png](../img_diagramas_BD/07-universidad.png)

## Vista de diagramas (para no confundirse)

### 1) Modelo relacional (diseno)

![Modelo relacional ejercicio 7](../../02-Modelado-basededatos/ER-a%20R/Relacional/7.png)

### 2) Diagrama SQL (implementacion en tablas)

![Diagrama SQL ejercicio 7](../img_diagramas_BD/07-universidad.png)

## Descripcion del ejercicio

Base de datos universitaria para alumnos, profesores, materias, departamentos y proyectos.

## Problematica

Se requiere integrar procesos academicos y administrativos en un solo esquema, con varias entidades y dependencias referenciales.
