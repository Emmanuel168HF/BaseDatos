# Ejercicio 6: Empresa (DeptNumber)

## Vinculos

- Base de datos (SQL): [03-Construccion-basededatos/DB/06_empresa_dept_number.sql](../DB/06_empresa_dept_number.sql)
- Modelo relacional (.drawio): [02-Modelado-basededatos/ER-a R/Relacional/6R_Empresa.drawio](../../02-Modelado-basededatos/ER-a%20R/Relacional/6R_Empresa.drawio)
- Imagen del modelo: [02-Modelado-basededatos/ER-a R/Relacional/6.png](../../02-Modelado-basededatos/ER-a%20R/Relacional/6.png)
- Diagrama SQL (imagen): [03-Construccion-basededatos/img_diagramas_BD/06-empresa_dept_number.png](../img_diagramas_BD/06-empresa_dept_number.png)

## Vista de diagramas (para no confundirse)

### 1) Modelo relacional (diseno)

![Modelo relacional ejercicio 6](../../02-Modelado-basededatos/ER-a%20R/Relacional/6.png)

### 2) Diagrama SQL (implementacion en tablas)

![Diagrama SQL ejercicio 6](../img_diagramas_BD/06-empresa_dept_number.png)

## Descripcion del ejercicio

Variante del modelo empresarial usando dept_number para referenciar departamentos.

## Problematica

Se debe conservar la misma estructura del ejercicio de empresa, asegurando consistencia de claves y validacion de horas en asignaciones.
